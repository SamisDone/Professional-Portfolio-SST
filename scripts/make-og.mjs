 ...
 * the site had become dark plum and Lobster Two.
 *
...
const lobster = b64("src/fonts/LobsterTwo.woff2");
const bricolage = b64("src/fonts/BricolageGrotesque.woff2");
...
const proof = [...src.matchAll(/value: "([^"]+)",\s*\n\s*label: "([^"]+)"/g)]
  .slice(0, 4)
...
@font-face { font-family: "Lobster Two"; src: url(data:font/woff2;base64,${lobster}) format("woff2"); font-weight: 400 }
@font-face { font-family: "Bricolage Grotesque"; src: url(data:font/woff2;base64,${bricolage}) format("woff2"); font-weight: 200 800; font-stretch: 75% 100% }
:root {
...
.eyebrow, .wordmark { font-size: 17px; letter-spacing: 0.2em; text-transform: uppercase; font-weight: 500 }
.eyebrow { color: hsl(var(--accent)) }
.wordmark { color: hsl(var(--muted)) }
h1 { font-family: "Lobster Two", cursive; font-weight: 400; font-size: 94px; line-height: 1.1 }
...
.proof div { flex: 1 }
.v { font-family: "Lobster Two", cursive; font-size: 40px; line-height: 1; color: hsl(var(--accent)) }
.l { margin-top: 9px; font-size: 16px; line-height: 1.35; color: hsl(var(--muted)) }
</style>
<div class="layer top"><span class="eyebrow">${standfirst}</span><span class="wordmark">Sarker</span></div>
<div class="layer">
  <h1>${name}</h1>
  <div class="rule"></div>
